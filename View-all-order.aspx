<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View-all-order.aspx.cs" Inherits="View_all_order" %>
        ...
        <table class="auto-style1">
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="#9933FF" Text="ALL ORDER"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
